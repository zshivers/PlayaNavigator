...
#ifndef LV_ATTRIBUTE_IMG_SPINNINGMAN08
#define LV_ATTRIBUTE_IMG_SPINNINGMAN08
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_SPINNINGMAN08 uint8_t SpinningMan08_map[] = {
...
const lv_img_dsc_t SpinningMan08 = {
